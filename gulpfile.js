...
const files = {
    ...
    jsPath: 'src/**/*.js',
    sassPath: 'src/**/*.scss',
    imgPath: 'src/**/*.+(png|jpeg|svg)', // match multiple patterns
    };
...
function jsFiles () {
    ...
    .pipe(dest('pub')) // Save those files into pub-directory
...
exports.default = series(
    parallel(htmlFiles, phpFiles, jsFiles, cssFiles, sassFiles, imgFiles, babelTranspile), // Runs all tasks simultaneously
